...
if __name__ == "__main__":
    ...
    for video_file in video_folder.glob("*.mp4"):
        ...
        info = inspect_video(str(video_file))
        
        output_audio = f"../../data/processed/audio/{video_file.stem}_extracted.mp3"
        extract_audio_from_video(str(video_file), output_audio)
