...
from src.storage.mongo import db, save_transcript_to_mongo

#AUDIO TEST
result = transcribe_audio( audio_path="../../data/raw/audio/How Amazon's Super-Complex Shipping System Works [2qanMpnYsjk].mp3", model_size='base', word_timestamps=True)
...
#VIDEO TEST
VIDEO      = '../../data/raw/video/How Amazon Became The Fastest Delivery System.mp4' 
...
result = transcribe_long_audio(
    audio_path="../../data/raw/audio/How Amazon's Super-Complex Shipping System Works [2qanMpnYsjk].mp3",
...
save_transcript_to_mongo(
    db,
    result, 
    source_path="../../data/raw/audio/How Amazon's Super-Complex Shipping System Works [2qanMpnYsjk].mp3",
    source_type="audio",
    json_path="../../data/processed/transcripts/sample.json",
    txt_path="../../data/processed/transcripts/sample.txt",
    srt_path="../../data/processed/transcripts/sample.srt"
)
